    ...
    <Grid item>
      <Card>
        ...
        <CardContent>
          ...
          <br/>
          <Typography variant="body2" color="textSecondary">Normally, the app doesn't delete audio files when users delete their test,
            because it may tak lots of time to query links and delete audio files. Test surveys follow the same rule.
