    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          <CardContent>
            <Typography>
              Golisten recently introduced storage limit for each user, you can check your usage by clicking your name
              on the upper right, and then you can check storage status in settings page. Or you can just click here{' '}
              <Link to="/user/settings" component={RouterLink}>
                Settings
              </Link>
            </Typography>
          </CardContent>
    ...
    return (
      <Grid item xs={12}>
        <Alert
          ...
          Please check the link which has been sent to your email address. If you didn't see the link you can click the
          button send another one.
        </Alert>
      </Grid>
    );
  else return null;
      ...
      <Card>
        ...
        <CardContent>
          <Typography>
            ...
            <Link href="https://www.linkedin.com/in/qijian-zhang-1112a217b/" target="_blank">
              Qijian Zhang
            </Link>
            ,{' '}
            <Link href="https://www.linkedin.com/in/dan-barry/" target="_blank">
              Dan Barry
            </Link>{' '}
            and{' '}
            <Link href="https://www.linkedin.com/in/andrew-hines/" target="_blank">
              Andrew Hines
            </Link>{' '}
            at{' '}
            <Link href="https://qxlab.ucd.ie/" target="_blank">
              QxLab
            </Link>{' '}
            in{' '}
            <Link href="https://www.ucd.ie/cs/" target="_blank">
              University College Dublin
            </Link>
            . The app is free to use including commercial use. Each user is given 500 MB of audio storage but if you
            need more email us using the details below. If you have found the app useful, please cite the app using the
            citation below.
          </Typography>
          ...
          <Typography>golisten@ucd.ie</Typography>

          <Typography variant="h5" className={classes.header}>
            Preferred Citation
          </Typography>
          <Typography>
            Barry, D., Zhang, Q., Sun, P.W. and Hines, A., 2021. Go Listen: An End-to-End Online Listening Test
            Platform. Journal of Open Research Software, 9(1), p.20. DOI: http://doi.org/10.5334/jors.361
          </Typography>

          <Typography variant="h5" className={classes.header} />
          <code>
            article{'{'}zhang_barry_sun_hines_2021, title={'{'}Go Listen: An End-to-End Online Listening Test Platform
            {'}'}, journal={'{'}Journal of Open Research Software{'}'}, author={'{'}Dan Barry and Qijian Zhang and
            Pheobe Wenyi Sun and Andrew Hines{'}'}, doi={'{'}10.5334/jors.361{'}'}, url={'{'}
            http://doi.org/10.5334/jors.361{'}'}, year={'{'}2021{'}'}
            {'}'}
          </code>
          ...
          <Typography>https://github.com/QxLabIreland/listening-test</Typography>
        </CardContent>
      </Card>
    </Grid>
  );
