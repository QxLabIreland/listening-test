          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                error={!!accountDeletion.errors.password}
                helperText={accountDeletion.errors.password}
              />
            </Grid>
          </Grid>
    ...
    return (
      <Card>
        ...
        <CardContent>
          ...
          <Typography>Number of files uploaded: {usage.totalNum}</Typography>
          <br />
          <Typography variant="body2" color="textSecondary">
            Each account has default 500MB storage. You can delete old or unused tests to free up space. Files with the
            same hash values will be only counted once.
          </Typography>
          {expandStorageAlert}
        </CardContent>
        <CardActions className={classes.flexEnd}>
          <Button color="primary" onClick={handlerExpandStorage}>
            Expanded storage
          </Button>
        </CardActions>
      </Card>
