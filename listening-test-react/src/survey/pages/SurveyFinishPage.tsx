...
export default function SurveyFinishPage() {
  ...
  const handleConfirmClick = () =>
    openDialog('This action will delete your response data permanently', 'Are you sure?', undefined, () =>
        ...
        {location.state ? (
          <>
            ...
            {!id && !testUrl ? (
              ...
              <Typography variant="body2" color="textSecondary" className={classes.paragraphCenter}>
                Your responses are anonymous but if you do wish delete your responses at a later time, please save and
                visit this link:{' '}
                <Link href={deletionLink} target="_blank">
                  {deletionLink}
                </Link>
              </Typography>
            )}
            ...
            <Button variant="contained" color="primary" component={RouterLink} to="/sign-up" target="_blank">
              Go sign up!
            </Button>
          </>
        ) : (
          <>
            <Typography variant="body2" className={classes.paragraph}>
              Are you sure you want to delete your responses {id}?. Your responses are anonymous but if you do wish
              delete your responses please click CONFIRM button.
            </Typography>
            <div className={classes.actions}>
              <Button color="secondary" onClick={handleConfirmClick} disabled={!!message}>
                CONFIRM
              </Button>
              {alert}
            </div>
