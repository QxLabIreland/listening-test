    ...
    switch (type) {
      case TestItemType.example:
        onAdd({
          ...
          title: 'Title (Click to edit this)',
          example: {
            medias: [{ filename: null, src: null, value: null, settings: { initVolume: 0.5, frequency: 500 } }],
            fields: [
              {
                type: SurveyControlType.description,
                question:
                  'Use the slider below to reduce the volume of this tone until it is just audible. When complete, click "Next"',
                value: null,
              },
            ],
          },
      ...
      case TestItemType.training:
        onAdd({
          ...
          title: 'Calibration for audio hardware volume (Click to edit this)',
          example: {
            medias: [],
            fields: [
              {
                type: SurveyControlType.description,
                question: 'Please listen and follow the instructions to calibrate your audio device.',
                value: null,
              },
            ],
          },
