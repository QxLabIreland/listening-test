...
export const FileUploadDropBox = observer(function (
  ...
  return (
    <>
      ...
      {isUploading ? (
        <Box p={2} className={classes.uploadBox}>
        ...
        <Box
          p={2}
          className={classes.uploadBox + ' ' + (hovering && classes.hovering)}
          onClick={() => fileRef.current.click()}
          onDragOver={handleFileUploadDragOver}
          onDrop={handleFileUploadDrop}
          onDragEnter={handleFileUploadEnter}
