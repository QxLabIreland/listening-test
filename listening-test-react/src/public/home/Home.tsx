    ...
    <div className={classes.background}>
      ...
      <Container component="main" className={classes.main} maxWidth="md">
        ...
        <Typography variant="h5" component="h2" gutterBottom align="center">
          Create and share a subjective listening test in a few minutes
          <br />
        </Typography>
...
function SimpleDialog() {
  ...
  return (
    <>
      <Button variant={'contained'} className={classes.seeDemo} onClick={handleOpen}>
        See a demo
      </Button>
      <Dialog onClose={handleClose} aria-labelledby="simple-dialog-title" open={open} maxWidth="md">
        <iframe
          ...
          src="https://www.youtube.com/embed/xd37rCfvA-4"
          frameBorder="0"
