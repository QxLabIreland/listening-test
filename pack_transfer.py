...
try:
    ...
    subprocess.run(f'scp -i golisten_ssh_key.pem -r {base_dir}/* golistenadmin@golisten.ucd.ie:/home/golistenadmin/golisten/', shell=True)
    ...
    subprocess.run('ssh -i golisten_ssh_key.pem -t golistenadmin@golisten.ucd.ie "sudo supervisorctl restart golisten"', shell=True)
